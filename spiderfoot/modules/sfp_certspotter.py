...
class sfp_certspotter(SpiderFootPlugin):
    ...
    # Default options
    opts = {"api_key": "", "verify": True, "max_pages": 20, "certexpiringdays": 30}
    ...
    def queryIssuances(self, domain, after=None):
        params = {
            "domain": domain.encode("raw_unicode_escape").decode(
        ...
        headers = {
            ...
            "Authorization": "Basic "
            + base64.b64encode(f"{self.opts['api_key']}:".encode("utf-8")).decode(
                "utf-8"
            ),
        }

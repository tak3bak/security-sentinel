...
class sfp_xforce(SpiderFootPlugin):
    ...
    def handleEvent(self, event):
        ...
        if (
            self.opts["xforce_api_key"] == ""
            or self.opts["xforce_api_key_password"] == ""
        ):
        ...
        for addr in qrylist:
            ...
            if rec:
                ...
                if len(rec_history) > 0:
                    ...
                    e = SpiderFootEvent(
                        "RAW_RIR_DATA", str(rec_history), self.__name__, event
                    )
            ...
            if rec:
                ...
                if len(rec_malware) > 0:
                    ...
                    e = SpiderFootEvent(
                        "RAW_RIR_DATA", str(rec_malware), self.__name__, event
                    )
                    self.notifyListeners(e)

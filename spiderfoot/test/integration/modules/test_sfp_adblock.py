...
class TestModuleIntegrationAdblock(unittest.TestCase):
    ...
    def test_handleEvent_event_data_provider_javascript_url_matching_ad_filter_should_return_event(
        self,
    ):
    ...
    def test_handleEvent_event_data_external_url_matching_ad_filter_should_return_event(
        self,
    ):
        sf = SpiderFoot(self.default_options)
    ...
    def test_handleEvent_event_data_external_url_not_matching_ad_filter_should_not_return_event(
        self,
    ):
        sf = SpiderFoot(self.default_options)

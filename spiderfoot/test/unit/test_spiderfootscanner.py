...
class TestSpiderFootScanner(unittest.TestCase):
    ...
    def test_init_argument_globalOpts_proxy_invalid_proxy_type_should_raise_ValueError(
        self,
    ):
        """
        Test __init__(self, scanName, scanId, scanTarget, targetType, moduleList, globalOpts)
    ...
    def test_init_argument_globalOpts_proxy_type_without_host_should_raise_ValueError(
        self,
    ):
        """
        Test __init__(self, scanName, scanId, scanTarget, targetType, moduleList, globalOpts)

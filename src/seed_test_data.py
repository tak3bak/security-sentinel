...
def seed():
    ...
    with open(mock_log_path, "w") as f:
        ...
        f.write(
            "Jun 30 10:00:01 server sshd[1234]: Failed password for root from 198.51.100.42 port 49152 ssh2\n"
        )
        f.write(
            "Jun 30 10:01:02 server sshd[1234]: Failed password for root from 198.51.100.42 port 49153 ssh2\n"
        )
        f.write(
            "Jun 30 10:02:03 server sshd[1234]: Failed password for invalid user admin from 198.51.100.42 port 49154 ssh2\n"
        )
        f.write(
            "Jun 30 10:03:04 server sshd[1234]: Failed password for root from 198.51.100.42 port 49155 ssh2\n"
        )

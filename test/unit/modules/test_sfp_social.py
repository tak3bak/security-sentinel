...
class TestModuleSocial(unittest.TestCase):
    ...
    def test_handleEvent_event_data_url_containing_social_media_profile_should_return_event(
        self,
    ):
        sf = SpiderFoot(self.default_options)
    ...
    def test_handleEvent_event_data_url_not_containing_social_media_profile_should_not_return_event(
        self,
    ):
        sf = SpiderFoot(self.default_options)

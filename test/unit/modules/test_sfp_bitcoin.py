...
class TestModuleBitcoin(unittest.TestCase):
    ...
    def test_handleEvent_event_data_containing_bitcoin_string_in_bech32_format_should_return_event(
        self,
    ):
        sf = SpiderFoot(self.default_options)
    ...
    def test_handleEvent_event_data_not_containing_bitcoin_string_should_not_return_event(
        self,
    ):
        sf = SpiderFoot(self.default_options)
